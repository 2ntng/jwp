...
if ('C:\xampp\htdocs\jwp\public\page\day4\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\xampp\htdocs\jwp\public\page\day4\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
